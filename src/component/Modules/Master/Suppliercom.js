            ...
            {loader ? <div className="loader-container">
                ...
                <div className='container-fluid'>
                    ...
                    <div className='container'>
                        <h1 className='text-center'>Supplier Master</h1>
                        {dailoge()}
                            ...
                            <table class="table border">
                                <thead >
                                    <tr >
                                        ...
                                        <th className='bg-light border border-left' scope="col" style={{ fontSize: '0.7rem' }}>Name</th>
                                ...
                                <tbody className='border'>
                                    {
                                        customerdata.map((item, i) => (
                                            <tr>
                                                ...
                                                <td className='border border-left' style={{ fontSize: '0.7rem' }}>{item.supplierName}</td>
