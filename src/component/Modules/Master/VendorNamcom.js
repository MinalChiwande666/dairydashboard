...
const VendorNamcom = () => {
    ...
    const vendortype = [
        ...
        {
            id:4,
            name:'Service and maintenance providers'
        },
        {
            id:5,
            name:'Independent vendors and trade show representatives'
        }
    ]
    const save = () => {
        alert(customerform)
            ...
            {loader ? <div className="loader-container">
                ...
                <div className='container-fluid'>
                    ...
                    <div className='container'>
                        <h1 className='text-center'>Vendor Master</h1>
                        {dailoge()}
                                ...
                                <tbody className='border'>
                                    {
                                        customerdata.map((item, i) => (
                                            <tr>
                                                ...
                                                <td className='border border-left' style={{ fontSize: '0.7rem' }}>{item.vendorName}</td>
